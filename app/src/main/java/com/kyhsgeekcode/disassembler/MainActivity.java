...
/*
		final MainActivity.platform[] all_tests = {
			new MainActivity.platform(Capstone.CS_ARCH_ARM, Capstone.CS_MODE_ARM, hexString2Byte(ARM_CODE), "ARM"),
...
*/
		...
		//	System.out.println("Disasm:");
			...
			Capstone.CsInsn[] all_ins = cs.disasm(hexString2Byte(ARM_CODE), 0x1000);
